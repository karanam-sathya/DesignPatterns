...
to create copies of objects without exposing their underlying implementation
details. It involves creating a prototype object and then cloning it to create
new instances. */
#include <iostream>
#include <string>
